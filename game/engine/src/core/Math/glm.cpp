...
#endif
#include <vendor/glm/glm/gtx/dual_quaternion.hpp>
#include <vendor/glm/glm/gtc/vec1.hpp>
#include <vendor/glm/glm/gtc/quaternion.hpp>
#include <vendor/glm/glm/ext/scalar_int_sized.hpp>
#include <vendor/glm/glm/ext/scalar_uint_sized.hpp>
